...
const createWindow = (): void => {
  ...
  const mainWindow = new BrowserWindow({
    ...
    webPreferences: {
      ...
      contextIsolation: false, // Isolate context to secure the app
  ...
  //     (input.type === 'keyDown' && input.key === 'R' && (input.control || input.meta) && input.shift) ||
  //     (input.type === 'keyDown' && input.key === 'F5')
  //   );

  //   if (isRefreshShortcut) {
  //     event.preventDefault();
  //     console.log('Refresh has been disabled!');
  //   }
  // });
